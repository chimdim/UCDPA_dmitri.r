...
if not date_is_same:
    ...
    if len(country_list) == 1:
        ...
        print(
            "The data available for {country} is not updated and therefore exact information about the worldwide Covid-19 status is not possible.".format(
    ...
    domain_name = re.search('\w*://(.*?)/\w*', COVID_API_URL).group(1)
